  ...
  return (
    <div className="bg-teal-700  rounded-2xl p-5 flex flex-col gap-4 h-full">
      ...
      <div className="bg-white/20 relative   rounded-xl px-4 py-3 flex items-center justify-between">
        ...
        {copied && (
          <p className="text-white text-xs absolute right-0 -top-3 -mt-2">
            Copied!
          </p>
        )}
      </div>
      ...
      <div className="flex items-start gap-3 bg-white/10 rounded-xl p-3">
        ...
        <p className="text-white text-xs leading-relaxed">
          Refer clients using this code to earn up to 5% commission on every
          ...
          <thead>
            <tr className="border-b border-gray-50">
              {[
                ...
                <th
                  key={h}
                  className="text-left px-5 py-3 text-xs text-gray-400 font-medium whitespace-nowrap"
                >
                  {h}
                </th>
              ))}
          ...
          <thead>
            <tr className="border-b border-gray-50">
              {["PROPERTY", "INVESTOR", "COMMISSION", "STATUS"].map((h) => (
                <th
                  key={h}
                  className="text-left px-5 py-3 text-xs text-gray-400 font-medium"
                >
                  {h}
                </th>
              ))}
  ...
  return (
    <div className="bg-gray-50 rounded-2xl border border-gray-100 p-5">
      ...
      <p className="text-xs text-gray-500 mb-4">
        Next payout cycle:{" "}
        <span className="font-semibold text-gray-700">Oct 30, 2023</span>
      </p>
      ...
      <p className="text-xs text-gray-500 mb-5 leading-relaxed">
        You've reached 66% of your monthly referral target. Reach $15k to unlock
        Platinum Tier commissions (6%).
      </p>
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">
            Track referrals, investments, and commissions.
          </p>
        </div>
      </div>
