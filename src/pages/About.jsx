      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl bg-emerald-50 border border-emerald-100">
              ...
              <p className="text-gray-500 text-sm">
                Every property, every transaction, and every distribution is
                clearly documented and shared with our investors.
              </p>
            </div>
            <div className="p-6 rounded-xl bg-emerald-50 border border-emerald-100">
              <h3 className="text-xl font-bold text-gray-900 mb-3">
              ...
              <p className="text-gray-500 text-sm">
                A single share is enough to become a co‑owner. No more
                gatekeeping by wealth or geography.
              </p>
            </div>
            <div className="p-6 rounded-xl bg-emerald-50 border border-emerald-100">
              <h3 className="text-xl font-bold text-gray-900 mb-3">
              ...
              <p className="text-gray-500 text-sm">
                Blockchain‑inspired tracking, smart monitoring, and automated
                payouts simplify property ownership.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="text-gray-500 text-base sm:text-lg mb-8 max-w-3xl mx-auto lg:mx-0">
            Become a partner in high‑yield properties with as little as one
            share. Start exploring, investing, and growing today.
          </p>
